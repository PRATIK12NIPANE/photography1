...
<head>
  ...
  <title>Testimonials - PJ Photography</title>
  <meta name="description" content="Read what our clients say about their wedding photography experience.">
...
<body class="min-h-screen overflow-x-hidden">
    ...
    <nav class="fixed top-0 w-full z-50 glass border-b border-white/10">
      <div class="max-w-7xl mx-auto px-6 flex justify-between items-center h-16">
        ...
        <div class="hidden md:flex items-center gap-6">
          ...
          <a href="testimonials.php" class="text-orange-400 border-b-2 border-orange-400 pb-1 transition magnetic">Testimonials</a>
    ...
    <div class="relative text-center px-6 z-10 glass p-8 rounded-3xl shadow-2xl mx-4 max-w-4xl">
            <h1 class="text-6xl md:text-8xl font-bold mb-4 leading-tight">
                <span class="block" style="color: var(--primary);">Client</span>
                <span class="block" style="color: var(--accent);">Testimonials</span>
            </h1>
            <p class="text-xl md:text-2xl mb-8 max-w-2xl mx-auto opacity-90">Trust us and just get us onboard — you'll be assured of memories that will last you a lifetime!</p>
        </div>
    </section>
    ...
    <section id="testimonials" class="py-24 px-6">
        ...
        <div class="glass rounded-2xl overflow-hidden tilt p-6 text-center transition-all duration-500">
            <img src="images/Crystalline-photography-2060.jpg" alt="Sarah & John" class="w-32 h-32 rounded-full mx-auto mb-4 object-cover border-4 border-orange-400">
            <h3 class="text-2xl font-bold mb-2 text-white">Sarah & John</h3>
            <p class="text-gray-300 leading-relaxed mb-4">"PJ Photography captured our wedding beautifully. The photos are timeless!"</p>
            <div class="text-yellow-400 text-xl">★★★★★</div>
        </div>
        <div class="glass rounded-2xl overflow-hidden tilt p-6 text-center transition-all duration-500">
            <img src="images/must-take-wedding-photos-bride-groom-walk-clary-prfeiffer-photography-0723-twitter-212172493c164f1986a02e9da665ff85.jpg" alt="Emma & Michael" class="w-32 h-32 rounded-full mx-auto mb-4 object-cover border-4 border-orange-400">
            <h3 class="text-2xl font-bold mb-2 text-white">Emma & Michael</h3>
            <p class="text-gray-300 leading-relaxed mb-4">"Professional, artistic, and fun to work with. Highly recommend!"</p>
            <div class="text-yellow-400 text-xl">★★★★★</div>
        </div>
        <div class="glass rounded-2xl overflow-hidden tilt p-6 text-center transition-all duration-500">
            <img src="images/images.jpeg" alt="Lisa & David" class="w-32 h-32 rounded-full mx-auto mb-4 object-cover border-4 border-orange-400">
            <h3 class="text-2xl font-bold mb-2 text-white">Lisa & David</h3>
            <p class="text-gray-300 leading-relaxed mb-4">"Their films brought tears to our eyes. Absolutely magical."</p>
            <div class="text-yellow-400 text-xl">★★★★★</div>
        </div>
        <div class="glass rounded-2xl overflow-hidden tilt p-6 text-center transition-all duration-500">
            <img src="images/images (1).jpeg" alt="Anna & James" class="w-32 h-32 rounded-full mx-auto mb-4 object-cover border-4 border-orange-400">
            <h3 class="text-2xl font-bold mb-2 text-white">Anna & James</h3>
            <p class="text-gray-300 leading-relaxed mb-4">"The couple shoot was perfect. We felt so comfortable and the results were stunning."</p>
            <div class="text-yellow-400 text-xl">★★★★★</div>
        </div>
        <div class="glass rounded-2xl overflow-hidden tilt p-6 text-center transition-all duration-500">
            <img src="images/82456c14fd1ca34a63a6d3bac59ad506.jpg" alt="Rachel & Tom" class="w-32 h-32 rounded-full mx-auto mb-4 object-cover border-4 border-orange-400">
            <h3 class="text-2xl font-bold mb-2 text-white">Rachel & Tom</h3>
            <p class="text-gray-300 leading-relaxed mb-4">"Worth every penny. Our wedding album is our most treasured possession."</p>
            <div class="text-yellow-400 text-xl">★★★★★</div>
        </div>
        <div class="glass rounded-2xl overflow-hidden tilt p-6 text-center transition-all duration-500">
            <img src="images/Crystalline-photography-2060.jpg" alt="Maya & Alex" class="w-32 h-32 rounded-full mx-auto mb-4 object-cover border-4 border-orange-400">
            <h3 class="text-2xl font-bold mb-2 text-white">Maya & Alex</h3>
            <p class="text-gray-300 leading-relaxed mb-4">"Exceeded all our expectations. Every photo tells our story perfectly."</p>
            <div class="text-yellow-400 text-xl">★★★★★</div>
        </div>
            </div>
        </div>
    ...
    <!-- AWARDS SECTION -->
    <section id="awards" class="py-24 px-6 bg-black/20">
        <div class="max-w-7xl mx-auto text-center">
            <h2 class="text-4xl md:text-5xl font-bold mb-12 text-white">
                <span style="color: var(--primary);">Awards &</span>
                <span style="color: var(--accent);"> Recognitions</span>
            </h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="glass rounded-2xl p-8 text-center transition-all duration-500">
                    <img src="images/Crystalline-photography-2060.jpg" alt="Wedding Photography Award" class="w-24 h-24 mx-auto mb-4 rounded-full object-cover">
                    <h3 class="text-xl font-bold mb-2 text-white">Best Wedding Photographer 2023</h3>
                    <p class="text-gray-300">Recognized by industry professionals for excellence in wedding photography.</p>
                </div>
                <div class="glass rounded-2xl p-8 text-center transition-all duration-500">
                    <img src="images/must-take-wedding-photos-bride-groom-walk-clary-prfeiffer-photography-0723-twitter-212172493c164f1986a02e9da665ff85.jpg" alt="Film Festival Award" class="w-24 h-24 mx-auto mb-4 rounded-full object-cover">
                    <h3 class="text-xl font-bold mb-2 text-white">Cinematic Excellence Award</h3>
                    <p class="text-gray-300">Awarded for outstanding cinematic wedding films and storytelling.</p>
                </div>
                <div class="glass rounded-2xl p-8 text-center transition-all duration-500">
                    <img src="images/images.jpeg" alt="Industry Recognition" class="w-24 h-24 mx-auto mb-4 rounded-full object-cover">
                    <h3 class="text-xl font-bold mb-2 text-white">Top 10 Wedding Photographers</h3>
                    <p class="text-gray-300">Ranked among the world's best wedding photographers.</p>
                </div>
            </div>
        </div>
    </section>
