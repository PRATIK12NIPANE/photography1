...
<head>
  ...
  <title>Portfolio - PJ Photography</title>
  <meta name="description" content="Explore our wedding photography portfolio. Stories of love captured beautifully.">
...
<body class="min-h-screen overflow-x-hidden">
    ...
    <nav class="fixed top-0 w-full z-50 glass border-b border-white/10">
      <div class="max-w-7xl mx-auto px-6 flex justify-between items-center h-16">
        ...
        <div class="hidden md:flex items-center gap-6">
          ...
          <a href="portfolio.php" class="text-orange-400 border-b-2 border-orange-400 pb-1 transition magnetic">Portfolio</a>
    ...
    <div class="relative text-center px-6 z-10 glass p-8 rounded-3xl shadow-2xl mx-4 max-w-4xl">
            <h1 class="text-6xl md:text-8xl font-bold mb-4 leading-tight">
                ...
                <span class="block" style="color: var(--accent);">Stories</span>
            </h1>
            <p class="text-xl md:text-2xl mb-8 max-w-2xl mx-auto opacity-90">Each wedding is a unique story. Here are some of our favorites.</p>
        </div>
    </section>
    ...
    <section id="portfolio" class="py-24 px-6">
        ...
        <div class="glass rounded-2xl overflow-hidden tilt p-6 text-center transition-all duration-500">
            <img src="images/Crystalline-photography-2060.jpg" alt="Wedding at Oleander Farms, Karjat – Dhruv & Pippa" class="w-full h-48 object-cover rounded-xl mb-4">
            <h3 class="text-2xl font-bold mb-2 text-white">Wedding at Oleander Farms, Karjat – Dhruv & Pippa</h3>
            <p class="text-gray-300 leading-relaxed mb-4">A beautiful farm wedding with intimate moments.</p>
            <a href="https://youtube.com/shorts/YveXNrr2_iI?si=6yt3I0yjgV4aCSO1" class="btn btn-primary">View Full Story</a>
        </div>
        <div class="glass rounded-2xl overflow-hidden tilt p-6 text-center transition-all duration-500">
            <img src="images/must-take-wedding-photos-bride-groom-walk-clary-prfeiffer-photography-0723-twitter-212172493c164f1986a02e9da665ff85.jpg" alt="Beach Wedding" class="w-full h-48 object-cover rounded-xl mb-4">
            <h3 class="text-2xl font-bold mb-2 text-white">Beach Wedding – Sarah & John</h3>
            <p class="text-gray-300 leading-relaxed mb-4">Sunset ceremony by the sea.</p>
            <a href="https://youtube.com/shorts/LjLngM5Z3FM?si=Jo6bPJ1yBGBJ0XLm" class="btn btn-primary">View Full Story</a>
        </div>
        <div class="glass rounded-2xl overflow-hidden tilt p-6 text-center transition-all duration-500">
            <img src="images/images.jpeg" alt="Garden Ceremony" class="w-full h-48 object-cover rounded-xl mb-4">
            <h3 class="text-2xl font-bold mb-2 text-white">Garden Ceremony – Emma & Michael</h3>
            <p class="text-gray-300 leading-relaxed mb-4">Elegant garden setting with floral arrangements.</p>
            <a href="https://youtube.com/shorts/x-LMpRj3c6g?si=6YA6xOjfkf2-OtBQ" class="btn btn-primary">View Full Story</a>
        </div>
        <div class="glass rounded-2xl overflow-hidden tilt p-6 text-center transition-all duration-500">
            <img src="images/images (1).jpeg" alt="Mountain Destination" class="w-full h-48 object-cover rounded-xl mb-4">
            <h3 class="text-2xl font-bold mb-2 text-white">Mountain Destination – Lisa & David</h3>
            <p class="text-gray-300 leading-relaxed mb-4">Scenic mountain backdrop for a romantic affair.</p>
            <a href="https://youtu.be/JNKZN8uq1H8?si=ge-HfDEddVP76JQy" class="btn btn-primary">View Full Story</a>
        </div>
        <div class="glass rounded-2xl overflow-hidden tilt p-6 text-center transition-all duration-500">
            <img src="images/82456c14fd1ca34a63a6d3bac59ad506.jpg" alt="Urban Wedding" class="w-full h-48 object-cover rounded-xl mb-4">
            <h3 class="text-2xl font-bold mb-2 text-white">Urban Wedding – Anna & James</h3>
            <p class="text-gray-300 leading-relaxed mb-4">Modern city venue with contemporary vibes.</p>
            <a href="https://youtu.be/tyBJioe8gOs?si=vt7uk16QQ5wUqLcv" class="btn btn-primary">View Full Story</a>
        </div>
        <div class="glass rounded-2xl overflow-hidden tilt p-6 text-center transition-all duration-500">
            <img src="images/Crystalline-photography-2060.jpg" alt="Vineyard Wedding" class="w-full h-48 object-cover rounded-xl mb-4">
            <h3 class="text-2xl font-bold mb-2 text-white">Vineyard Wedding – Rachel & Tom</h3>
            <p class="text-gray-300 leading-relaxed mb-4">Rustic vineyard setting with wine country charm.</p>
            <a href="https://youtube.com/shorts/q4UdtKD6K4k?si=fG7yomGqK757v_KF" class="btn btn-primary">View Full Story</a>
        </div>
            </div>
        </div>
    </section>
