...
<head>
  ...
  <title>FAQ - PJ Photography</title>
  <meta name="description" content="Frequently asked questions about our wedding photography services.">
...
<body class="min-h-screen overflow-x-hidden">
    ...
    <nav class="fixed top-0 w-full z-50 glass border-b border-white/10">
      <div class="max-w-7xl mx-auto px-6 flex justify-between items-center h-16">
        ...
        <div class="hidden md:flex items-center gap-6">
          ...
          <a href="faq.php" class="text-orange-400 border-b-2 border-orange-400 pb-1 transition magnetic">FAQ</a>
    ...
    <div class="relative text-center px-6 z-10 glass p-8 rounded-3xl shadow-2xl mx-4 max-w-4xl">
            <h1 class="text-6xl md:text-8xl font-bold mb-4 leading-tight">
                <span class="block" style="color: var(--primary);">Frequently Asked</span>
                <span class="block" style="color: var(--accent);">Questions</span>
            </h1>
            <p class="text-xl md:text-2xl mb-8 max-w-2xl mx-auto opacity-90">Get answers to common questions about our wedding photography services.</p>
        </div>
    </section>
    ...
    <section id="faq" class="py-24 px-6">
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 max-w-4xl mx-auto gap-8">
        <div class="glass rounded-2xl overflow-hidden tilt p-8 transition-all duration-500">
            <h3 class="text-2xl font-bold mb-4 text-white">Why choose PJ Photography?</h3>
            <p class="text-gray-300 leading-relaxed">We offer artistic, professional photography with a focus on candid moments and fine-art compositions. Our team is experienced and responsive, bringing creativity and passion to every wedding we capture.</p>
        </div>
        <div class="glass rounded-2xl overflow-hidden tilt p-8 transition-all duration-500">
            <h3 class="text-2xl font-bold mb-4 text-white">How is our work different from others?</h3>
            <p class="text-gray-300 leading-relaxed">Our style mixes candid reportage, fine-art compositions, and editorial light — so your photos look like they belong in a magazine. We master natural light and create emotional, evocative images that tell your unique story.</p>
        </div>
        <div class="glass rounded-2xl overflow-hidden tilt p-8 transition-all duration-500">
            <h3 class="text-2xl font-bold mb-4 text-white">Do you cover destination weddings?</h3>
            <p class="text-gray-300 leading-relaxed">Yes, we travel worldwide for destination weddings. We handle all logistics and ensure the same quality service from Mumbai to any location. Your wedding deserves perfect documentation, regardless of the setting.</p>
        </div>
        <div class="glass rounded-2xl overflow-hidden tilt p-8 transition-all duration-500">
            <h3 class="text-2xl font-bold mb-4 text-white">How many team members come for weddings?</h3>
            <p class="text-gray-300 leading-relaxed">Typically 2-4 team members depending on the package and wedding size. We coordinate seamlessly to ensure every moment is captured without disrupting your celebration. More coverage means better documentation.</p>
        </div>
        <div class="glass rounded-2xl overflow-hidden tilt p-8 transition-all duration-500">
            <h3 class="text-2xl font-bold mb-4 text-white">How are your services priced?</h3>
            <p class="text-gray-300 leading-relaxed">Every wedding is unique—our pricing depends on number of days, location, team size, and specific requirements. We tailor quotes based on your vision and needs, ensuring you get exceptional value for your investment.</p>
        </div>
        <div class="glass rounded-2xl overflow-hidden tilt p-8 transition-all duration-500">
            <h3 class="text-2xl font-bold mb-4 text-white">What are your delivery timelines?</h3>
            <p class="text-gray-300 leading-relaxed">Photos are delivered within 4-6 weeks. Films take 6-8 weeks to create cinematic magic. Rush options are available for urgent needs. Quality takes time, but we deliver beautiful results that last forever.</p>
        </div>
            </div>
        </div>
    </section>
